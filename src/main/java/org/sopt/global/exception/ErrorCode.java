...
public enum ErrorCode {
    ...
    API_NOT_FOUND(101, NOT_FOUND.value(), "존재하지 않는 API 입니다."),
    INTERNAL_SERVER_ERROR(102, HttpStatus.INTERNAL_SERVER_ERROR.value(), "서버 내부 오류입니다."),
    INVALID_SIGNATURE(103, HttpStatus.UNAUTHORIZED.value(), "잘못된 서명입니다."),
    TOKEN_EXPIRED(104, HttpStatus.UNAUTHORIZED.value(), "만료된 토큰입니다."),
    UNSUPPORTED_TOKEN(105, BAD_REQUEST.value(), "지원하지 않는 토큰입니다."),
    INVALID_TOKEN(106, BAD_REQUEST.value(), "잘못된 토큰입니다."),
    UNAUTHORIZED(107, HttpStatus.UNAUTHORIZED.value(), "인증되지 않은 사용자입니다."),
    FORBIDDEN(108, HttpStatus.FORBIDDEN.value(), "권한이 없습니다."),
    ...
    POST_NOT_FOUND(204, NOT_FOUND.value(), "해당 ID의 게시글이 존재하지 않습니다."),
    CANNOT_UPDATE_POST(205, HttpStatus.FORBIDDEN.value(), "게시물 작성자 본인만 게시물을 수정할 수 있습니다."),
    CANNOT_DELETE_POST(206, HttpStatus.FORBIDDEN.value(), "게시물 작성자 본인만 게시물을 삭제할 수 있습니다."),
    ...
    CANNOT_UPDATE_COMMENT(401, HttpStatus.FORBIDDEN.value(), "댓글 작성자 본인만 댓글을 수정할 수 있습니다."),
    CANNOT_DELETE_COMMENT(402, HttpStatus.FORBIDDEN.value(), "댓글 작성자 본인만 댓글을 삭제할 수 있습니다.")
    ;
